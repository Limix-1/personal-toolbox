from tool_UI import tool0UI
from tool_UI import tool1UI
from tool_UI import tool2UI
from tool_UI import tool3UI
from tool_UI import tool4UI
...
button2 = tk.Button(root, text="打开工具", command=lambda x=root: tool3UI.tool3(x))
